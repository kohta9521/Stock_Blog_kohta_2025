  ...
  return (
    ...
    >
      <div className="w-full flex justify-between mb-3">
        <p className="bg-red-600 text-white px-2 py-1 rounded-xl text-xs font-medium">
          {category}
        </p>
        <p className="block font-medium text-sm text-gray-500">{date}</p>
      </div>
      <h3 className="block w-full text-sm font-medium text-gray-800 mb-2 line-clamp-2 transition-all duration-300 group-hover:text-gray-400 sm:text-sm sm:break-words sm:mb-3">
        {title}
      </h3>
    </Link>
  );
